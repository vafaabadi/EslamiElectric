...
const SEO_ROUTES = {
  '': {
    en: {
      ...
      description:
        'Shop quality cables, lighting, sockets, and electrical supplies at Eslami Electric in Zahedan, Sistan and Baluchestan. Fast local service and online ordering.'
    },
    fa: {
...
function stripMetaDescription(html) {
  return html.replace(/<meta\s+name="description"\s+content="[^"]*"\s*\/?>\s*/gi, '');
}
