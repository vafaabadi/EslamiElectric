...
function buildContentSecurityPolicy(opts) {
  ...
  const parts = [
    ...
    "manifest-src 'self'",
    "worker-src 'self'",
    "script-src 'self' https://cdn.jsdelivr.net https://telegram.org https://va.vercel-scripts.com 'unsafe-inline'",
    "style-src 'self' https://cdn.jsdelivr.net 'unsafe-inline'",
    "img-src 'self' data: blob: https:",
    "font-src 'self' data: https:",
    'connect-src ' + Array.from(connect).join(' '),
    "frame-src 'self' https://telegram.org https://oauth.telegram.org https://js.stripe.com https://hooks.stripe.com https://checkout.stripe.com https://*.stripe.com",
